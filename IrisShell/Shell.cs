...
namespace IrisShell
{
    public sealed class Shell
    {
        ...
        private readonly Dictionary<StringToken, CompiledExpression> _cache;
        ...
        public Shell(bool catchExceptions = true)
        {
            ...
            _cache = new Dictionary<StringToken, CompiledExpression>();
        ...
        public ExecutionResult Execute(StringToken input)
        {
            ...
            if (_cache.TryGetValue(input, out CompiledExpression compiledExpression))
